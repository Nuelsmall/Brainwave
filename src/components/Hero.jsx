...
//         mx-auto text-center mb-[4rem] md:mb-20 lg:mb:[6rem] lg:mt-40"
//         >
...
//                 bottom-5 md:left-1/2 md:right-auto md:bottom-8
...
//                         bg-n-9/10 backdrop-blur border
...
const Hero = () => {
  const parallaxRef = useRef(null); // Reference for the parallax effect
  ...
  return (
    ...
    >
      <div className="container relative" ref={parallaxRef}>
        <div className="relative z-1 max-w-[62rem] mx-auto text-center mb-[4rem] md:mb-20 lg:mb-[6rem] lg:mt-40">
          <h1 className="h1 mb-6">
            Explore the possibilities of&nbsp; AI&nbsp; Chatting with {` `}
            <span className="inline-block relative">
              Brainwave
